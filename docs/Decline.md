...
**button_text** | **String** |  Specifies the decline text displayed in the tab. | [optional] 
...
**decline_reason** | **String** | The reason the recipient declined the document. | [optional] 
