...
module DocuSign_eSign
  ...
  class SigningGroupsApi
    ...
    def create_list_with_http_info(account_id, signing_group_information)
      ...
      # resource path
      local_var_path = "/v2/accounts/{accountId}/signing_groups".sub('{format}','json').sub('{' + 'accountId' + '}', account_id.to_s)
    ...
    def delete_users_with_http_info(account_id, signing_group_id, signing_group_users)
      ...
      # resource path
      local_var_path = "/v2/accounts/{accountId}/signing_groups/{signingGroupId}/users".sub('{format}','json').sub('{' + 'accountId' + '}', account_id.to_s).sub('{' + 'signingGroupId' + '}', signing_group_id.to_s)
    ...
    def get_with_http_info(account_id, signing_group_id)
      ...
      # resource path
      local_var_path = "/v2/accounts/{accountId}/signing_groups/{signingGroupId}".sub('{format}','json').sub('{' + 'accountId' + '}', account_id.to_s).sub('{' + 'signingGroupId' + '}', signing_group_id.to_s)
