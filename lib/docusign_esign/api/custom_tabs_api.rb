...
module DocuSign_eSign
  ...
  class CustomTabsApi
    ...
    def create_with_http_info(account_id, tab_metadata)
      ...
      # resource path
      local_var_path = "/v2/accounts/{accountId}/tab_definitions".sub('{format}','json').sub('{' + 'accountId' + '}', account_id.to_s)
    ...
    def delete_with_http_info(account_id, custom_tab_id)
      ...
      # resource path
      local_var_path = "/v2/accounts/{accountId}/tab_definitions/{customTabId}".sub('{format}','json').sub('{' + 'accountId' + '}', account_id.to_s).sub('{' + 'customTabId' + '}', custom_tab_id.to_s)
