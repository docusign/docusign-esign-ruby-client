...
module DocuSign_eSign
  class UserAccountManagementGranularInformation
    ...
    attr_accessor :can_view_users_metadata
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'canManageGroupsMetadata')
      ...
      if attributes.has_key?(:'canViewUsersMetadata')
        self.can_view_users_metadata = attributes[:'canViewUsersMetadata']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          can_view_users_metadata == o.can_view_users_metadata
    end
