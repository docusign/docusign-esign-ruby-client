...
module DocuSign_eSign
  ...
  class CorrectViewRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'beginOnTagger')
        self.begin_on_tagger = attributes[:'beginOnTagger']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          begin_on_tagger == o.begin_on_tagger &&
    ...
    def hash
      [begin_on_tagger, return_url, suppress_navigation, view_url].hash
    end
