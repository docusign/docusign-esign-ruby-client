...
module DocuSign_eSign
  ...
  class TemplateNotificationRequest
    ...
    attr_accessor :use_account_defaults
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'useAccountDefaults')
        self.use_account_defaults = attributes[:'useAccountDefaults']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          use_account_defaults == o.use_account_defaults
    end
    ...
    def hash
      [expirations, password, reminders, use_account_defaults].hash
    end
