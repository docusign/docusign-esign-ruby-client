...
module DocuSign_eSign
  ...
  class BillingPaymentsResponse
    # Reserved: TBD
    attr_accessor :billing_payments
    ...
    def self.swagger_types
      {
        :'billing_payments' => :'Array<BillingPaymentItem>',
        :'next_uri' => :'String',
        :'previous_uri' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'billingPayments')
        if (value = attributes[:'billingPayments']).is_a?(Array)
          self.billing_payments = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          billing_payments == o.billing_payments &&
          next_uri == o.next_uri &&
    ...
    def hash
      [billing_payments, next_uri, previous_uri].hash
    end
