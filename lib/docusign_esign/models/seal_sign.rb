...
module DocuSign_eSign
  ...
  class SealSign
    ...
    def hash
      [access_code, add_access_code_to_email, client_user_id, custom_fields, declined_date_time, declined_reason, delivered_date_time, delivery_method, document_visibility, email_notification, embedded_recipient_start_url, error_details, fax_number, id_check_configuration_name, id_check_information_input, inherit_email_notification_configuration, name, note, phone_authentication, recipient_attachments, recipient_authentication_status, recipient_id, recipient_id_guid, recipient_signature_providers, require_id_lookup, role_name, routing_order, saml_authentication, sent_date_time, signed_date_time, sms_authentication, social_authentications, status, tabs, template_locked, template_required, total_tab_count, user_id].hash
    end
