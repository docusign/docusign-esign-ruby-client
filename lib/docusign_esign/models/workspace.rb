...
module DocuSign_eSign
  ...
  class Workspace
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'callerInformation')
        self.caller_information = attributes[:'callerInformation']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          caller_information == o.caller_information &&
          created == o.created &&
    ...
    def hash
      [billable_account_id, caller_information, created, created_by_information, last_modified, last_modified_by_information, settings, status, workspace_base_url, workspace_description, workspace_id, workspace_name, workspace_uri].hash
    end
