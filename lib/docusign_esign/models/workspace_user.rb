...
module DocuSign_eSign
  ...
  class WorkspaceUser
    ...
    def hash
      [account_id, account_name, active_since, created, created_by_id, email, error_details, last_modified, last_modified_by_id, status, type, user_id, user_name, workspace_id, workspace_user_base_url, workspace_user_id].hash
    end
