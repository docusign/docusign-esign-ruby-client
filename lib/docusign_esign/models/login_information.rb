...
module DocuSign_eSign
  ...
  class LoginInformation
    ...
    def self.swagger_types
      {
        :'api_password' => :'String',
        :'login_accounts' => :'Array<LoginAccount>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'loginAccounts')
        if (value = attributes[:'loginAccounts']).is_a?(Array)
          self.login_accounts = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          login_accounts == o.login_accounts
    end
    ...
    def hash
      [api_password, login_accounts].hash
    end
