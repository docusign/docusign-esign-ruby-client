...
module DocuSign_eSign
  class UserSocialIdResult
    ...
    def self.swagger_types
      {
        :'social_account_information' => :'Array<SocialAccountInformation>',
        :'user_id' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'socialAccountInformation')
        if (value = attributes[:'socialAccountInformation']).is_a?(Array)
          self.social_account_information = value
        end
      end
    ...
    def hash
      [social_account_information, user_id].hash
    end
