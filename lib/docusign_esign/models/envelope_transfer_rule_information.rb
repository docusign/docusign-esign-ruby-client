...
module DocuSign_eSign
  ...
  class EnvelopeTransferRuleInformation
    ...
    # 
    attr_accessor :envelope_transfer_rules
    ...
    def self.swagger_types
      {
        :'end_position' => :'String',
        :'envelope_transfer_rules' => :'Array<EnvelopeTransferRule>',
        :'next_uri' => :'String',
        :'previous_uri' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'envelopeTransferRules')
        if (value = attributes[:'envelopeTransferRules']).is_a?(Array)
          self.envelope_transfer_rules = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          envelope_transfer_rules == o.envelope_transfer_rules &&
          next_uri == o.next_uri &&
    ...
    def hash
      [end_position, envelope_transfer_rules, next_uri, previous_uri, result_set_size, start_position, total_set_size].hash
    end
