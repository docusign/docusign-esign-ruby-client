...
module DocuSign_eSign
  ...
  class Attachment
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'accessControl')
        self.access_control = attributes[:'accessControl']
      end
    ...
    def hash
      [access_control, attachment_id, attachment_type, data, label, name, remote_url].hash
    end
