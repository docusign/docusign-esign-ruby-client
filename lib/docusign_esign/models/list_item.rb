...
module DocuSign_eSign
  class ListItem
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'textMetadata')
        self.text_metadata = attributes[:'textMetadata']
      end
    ...
    def hash
      [selected, selected_metadata, text, text_metadata, value, value_metadata].hash
    end
