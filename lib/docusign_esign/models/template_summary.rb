...
module DocuSign_eSign
  class TemplateSummary
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'templateMatch')
        self.template_match = attributes[:'templateMatch']
      end
    ...
    def hash
      [applied, document_id, document_name, name, template_id, template_match, uri].hash
    end
