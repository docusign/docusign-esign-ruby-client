...
module DocuSign_eSign
  ...
  class AccountNotification
    ...
    # 
    attr_accessor :user_override_enabled
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'userOverrideEnabled')
        self.user_override_enabled = attributes[:'userOverrideEnabled']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          user_override_enabled == o.user_override_enabled
    end
    ...
    def hash
      [expirations, reminders, user_override_enabled].hash
    end
