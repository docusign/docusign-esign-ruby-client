...
module DocuSign_eSign
  class TemplateViewSettings
    ...
    def hash
      [back_button_action, document_settings, envelope_custom_field_settings, lock_token, recipient_settings, show_advanced_options, show_back_button, show_discard_action, show_header_actions, starting_screen, tagger_settings].hash
    end
