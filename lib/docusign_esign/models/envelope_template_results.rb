...
module DocuSign_eSign
  ...
  class EnvelopeTemplateResults
    ...
    attr_accessor :envelope_templates
    ...
    def self.swagger_types
      {
        :'end_position' => :'String',
        :'envelope_templates' => :'Array<EnvelopeTemplateResult>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'envelopeTemplates')
        if (value = attributes[:'envelopeTemplates']).is_a?(Array)
          self.envelope_templates = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          envelope_templates == o.envelope_templates &&
          folders == o.folders &&
          next_uri == o.next_uri &&
    ...
    def hash
      [end_position, envelope_templates, folders, next_uri, previous_uri, result_set_size, start_position, total_set_size].hash
    end
