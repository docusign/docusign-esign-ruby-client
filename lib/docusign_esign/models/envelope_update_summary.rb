...
module DocuSign_eSign
  ...
  class EnvelopeUpdateSummary
    ...
    def hash
      [bulk_envelope_status, envelope_id, error_details, list_custom_field_update_results, lock_information, recipient_update_results, tab_update_results, text_custom_field_update_results].hash
    end
