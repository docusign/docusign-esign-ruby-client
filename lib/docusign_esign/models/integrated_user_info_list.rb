...
module DocuSign_eSign
  class IntegratedUserInfoList
    # 
    attr_accessor :all_users_selected
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'allUsersSelected')
        self.all_users_selected = attributes[:'allUsersSelected']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          all_users_selected == o.all_users_selected &&
    ...
    def hash
      [all_users_selected, end_position, next_uri, previous_uri, result_set_size, start_position, total_set_size, users].hash
    end
