  ...
  class BillingInvoicesSummary
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'pastDueBalance')
        self.past_due_balance = attributes[:'pastDueBalance']
      end

      if attributes.has_key?(:'paymentAllowed')
        self.payment_allowed = attributes[:'paymentAllowed']
      end
    end
