...
module DocuSign_eSign
  class RecipientSignatureProvider
    ...
    attr_accessor :signature_provider_name_metadata
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'signatureProviderNameMetadata')
        self.signature_provider_name_metadata = attributes[:'signatureProviderNameMetadata']
      end

      if attributes.has_key?(:'signatureProviderOptions')
        self.signature_provider_options = attributes[:'signatureProviderOptions']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          signature_provider_name_metadata == o.signature_provider_name_metadata &&
    ...
    def hash
      [seal_documents_with_tabs_only, seal_name, signature_provider_name, signature_provider_name_metadata, signature_provider_options].hash
    end
