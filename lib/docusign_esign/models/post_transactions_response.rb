...
module DocuSign_eSign
  ...
  class PostTransactionsResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'transactionSid')
        self.transaction_sid = attributes[:'transactionSid']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          transaction_sid == o.transaction_sid
    end
    ...
    def hash
      [document_data, transaction_sid].hash
    end
