...
module DocuSign_eSign
  ...
  class CommentPublish
    ...
    # 
    attr_accessor :thread_anchor_keys
    ...
    def self.swagger_types
      {
        ...
        :'text' => :'String',
        :'thread_anchor_keys' => :'Hash<String, String>',
        :'thread_id' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'threadAnchorKeys')
        if (value = attributes[:'threadAnchorKeys']).is_a?(Array)
          self.thread_anchor_keys = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          mentions == o.mentions &&
          text == o.text &&
          thread_anchor_keys == o.thread_anchor_keys &&
    ...
    def hash
      [id, mentions, text, thread_anchor_keys, thread_id, visible_to].hash
    end
