...
module DocuSign_eSign
  ...
  class Checkbox
    ...
    def hash
      [anchor_case_sensitive, anchor_horizontal_alignment, anchor_ignore_if_not_present, anchor_match_whole_word, anchor_string, anchor_units, anchor_x_offset, anchor_y_offset, conditional_parent_label, conditional_parent_value, custom_tab_id, document_id, error_details, locked, merge_field, name, page_number, recipient_id, required, require_initial_on_shared_change, selected, shared, status, tab_id, tab_label, tab_order, template_locked, template_required, x_position, y_position].hash
    end
