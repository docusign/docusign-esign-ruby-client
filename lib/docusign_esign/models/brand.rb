...
module DocuSign_eSign
  class Brand
    ...
    def hash
      [brand_company, brand_id, brand_name, colors, email_content, error_details, is_overriding_company_name, is_sending_default, is_signing_default, landing_pages, links, logos, resources].hash
    end
