...
module DocuSign_eSign
  ...
  class BulkEnvelopeStatus
    ...
    # Reserved: TBD
    attr_accessor :bulk_envelopes

    # Reserved: TBD
    attr_accessor :bulk_envelopes_batch_uri
    ...
    def self.swagger_types
      {
        :'batch_id' => :'String',
        :'batch_size' => :'String',
        :'bulk_envelopes' => :'Array<BulkEnvelope>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bulkEnvelopes')
        if (value = attributes[:'bulkEnvelopes']).is_a?(Array)
          self.bulk_envelopes = value
        end
      end

      if attributes.has_key?(:'bulkEnvelopesBatchUri')
        self.bulk_envelopes_batch_uri = attributes[:'bulkEnvelopesBatchUri']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          bulk_envelopes == o.bulk_envelopes &&
          bulk_envelopes_batch_uri == o.bulk_envelopes_batch_uri &&
    ...
    def hash
      [batch_id, batch_size, bulk_envelopes, bulk_envelopes_batch_uri, end_position, failed, next_uri, previous_uri, queued, result_set_size, sent, start_position, submitted_date, total_set_size].hash
    end
