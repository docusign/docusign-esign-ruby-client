...
module DocuSign_eSign
  class PaymentDetails
    ...
    def hash
      [allowed_payment_methods, charge_id, currency_code, customer_id, custom_metadata, custom_metadata_required, gateway_account_id, gateway_display_name, gateway_name, line_items, payment_option, payment_source_id, signer_values, status, total].hash
    end
