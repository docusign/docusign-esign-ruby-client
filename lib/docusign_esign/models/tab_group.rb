...
>>>>>>> 21be361feb7dcf8e34f4d3df2412dedff41c20d5
      ...
      if attributes.has_key?(:'groupLabel')
        self.group_label = attributes[:'groupLabel']
      end

      if attributes.has_key?(:'groupLabelMetadata')
        self.group_label_metadata = attributes[:'groupLabelMetadata']
      end

      if attributes.has_key?(:'groupRule')
        self.group_rule = attributes[:'groupRule']
      end

      if attributes.has_key?(:'groupRuleMetadata')
        self.group_rule_metadata = attributes[:'groupRuleMetadata']
      end
      ...
      if attributes.has_key?(:'maximumAllowed')
        self.maximum_allowed = attributes[:'maximumAllowed']
      end

      if attributes.has_key?(:'maximumAllowedMetadata')
        self.maximum_allowed_metadata = attributes[:'maximumAllowedMetadata']
      end
      ...
      if attributes.has_key?(:'minimumRequired')
        self.minimum_required = attributes[:'minimumRequired']
      end

      if attributes.has_key?(:'minimumRequiredMetadata')
        self.minimum_required_metadata = attributes[:'minimumRequiredMetadata']
      end
...
>>>>>>> 21be361feb7dcf8e34f4d3df2412dedff41c20d5
      ...
      if attributes.has_key?(:'tabScope')
        self.tab_scope = attributes[:'tabScope']
      end

      if attributes.has_key?(:'tabScopeMetadata')
        self.tab_scope_metadata = attributes[:'tabScopeMetadata']
      end
...
>>>>>>> 21be361feb7dcf8e34f4d3df2412dedff41c20d5
          ...
          group_label_metadata == o.group_label_metadata &&
          group_rule == o.group_rule &&
          group_rule_metadata == o.group_rule_metadata &&
          height == o.height &&
          height_metadata == o.height_metadata &&
          maximum_allowed == o.maximum_allowed &&
          maximum_allowed_metadata == o.maximum_allowed_metadata &&
          merge_field == o.merge_field &&
          merge_field_xml == o.merge_field_xml &&
          minimum_required == o.minimum_required &&
          minimum_required_metadata == o.minimum_required_metadata &&
...
>>>>>>> 21be361feb7dcf8e34f4d3df2412dedff41c20d5
          ...
          tab_scope == o.tab_scope &&
          tab_scope_metadata == o.tab_scope_metadata &&
          tab_type == o.tab_type &&
