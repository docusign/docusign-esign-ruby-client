...
module DocuSign_eSign
  ...
  class Expirations
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'expireWarn')
        self.expire_warn = attributes[:'expireWarn']
      end
    ...
    def hash
      [expire_after, expire_enabled, expire_warn].hash
    end
