...
module DocuSign_eSign
  class TabAccountSettings
    ...
    attr_accessor :checkbox_tabs_metadata
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'checkboxTabsMetadata')
        self.checkbox_tabs_metadata = attributes[:'checkboxTabsMetadata']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          checkbox_tabs_metadata == o.checkbox_tabs_metadata &&
