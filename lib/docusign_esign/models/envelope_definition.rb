...
module DocuSign_eSign
  ...
  class EnvelopeDefinition
    ...
    def hash
      [accessibility, allow_markup, allow_reassign, allow_recipient_recursion, asynchronous, attachments, attachments_uri, authoritative_copy, auto_navigation, brand_id, brand_lock, certificate_uri, completed_date_time, composite_templates, created_date_time, custom_fields, custom_fields_uri, declined_date_time, deleted_date_time, delivered_date_time, documents, documents_combined_uri, documents_uri, email_blurb, email_settings, email_subject, enable_wet_sign, enforce_signer_visibility, envelope_id, envelope_id_stamping, envelope_uri, event_notification, initial_sent_date_time, is21_cfr_part11, is_signature_provider_envelope, last_modified_date_time, lock_information, message_lock, notification, notification_uri, password, purge_state, recipients, recipients_lock, recipients_uri, sent_date_time, signing_location, status, status_changed_date_time, template_id, template_roles, templates_uri, transaction_id, use_disclosure, voided_date_time, voided_reason].hash
    end
