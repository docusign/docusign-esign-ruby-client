...
module DocuSign_eSign
  class SmartSection
    ...
    def hash
      [anchor_case_sensitive, anchor_horizontal_alignment, anchor_ignore_if_not_present, anchor_match_whole_word, anchor_string, anchor_units, anchor_x_offset, anchor_y_offset, case_sensitive, conditional_parent_label, conditional_parent_value, custom_tab_id, display_settings, document_id, end_anchor, end_position, error_details, merge_field, page_number, recipient_id, remove_end_anchor, remove_start_anchor, start_anchor, start_position, status, tab_group_labels, tab_id, tab_order, template_locked, template_required, tooltip, x_position, y_position].hash
    end
