...
module DocuSign_eSign
  ...
  class BillingPlanPreview
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isProrated')
        self.is_prorated = attributes[:'isProrated']
      end

      if attributes.has_key?(:'subtotalAmount')
        self.subtotal_amount = attributes[:'subtotalAmount']
      end
    ...
    def hash
      [currency_code, invoice, is_prorated, subtotal_amount, tax_amount, total_amount].hash
    end
