...
module DocuSign_eSign
  class PowerFormSendersResponse
    ...
    # 
    attr_accessor :power_form_senders
    ...
    def self.swagger_types
      {
        :'end_position' => :'String',
        :'next_uri' => :'String',
        :'power_form_senders' => :'Array<UserInfo>',
        :'previous_uri' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'powerFormSenders')
        if (value = attributes[:'powerFormSenders']).is_a?(Array)
          self.power_form_senders = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          next_uri == o.next_uri &&
          power_form_senders == o.power_form_senders &&
    ...
    def hash
      [end_position, next_uri, power_form_senders, previous_uri, result_set_size, start_position, total_set_size].hash
    end
