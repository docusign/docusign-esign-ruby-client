...
module DocuSign_eSign
  ...
  class AuthenticationMethod
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lastProvider')
        self.last_provider = attributes[:'lastProvider']
      end
    ...
    def hash
      [authentication_type, last_provider, last_timestamp, total_count].hash
    end
