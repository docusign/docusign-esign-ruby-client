...
module DocuSign_eSign
  class PaymentGatewayAccount
    ...
    # 
    attr_accessor :zero_decimal_currencies
    ...
    def self.swagger_types
      {
        ...
        :'zero_decimal_currencies' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'zeroDecimalCurrencies')
        if (value = attributes[:'zeroDecimalCurrencies']).is_a?(Array)
          self.zero_decimal_currencies = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          zero_decimal_currencies == o.zero_decimal_currencies
    end
    ...
    def hash
      [allow_custom_metadata, config, display_name, is_enabled, is_legacy, last_modified, payment_gateway, payment_gateway_account_id, payment_gateway_display_name, pay_pal_legacy_settings, supported_currencies, supported_payment_methods, supported_payment_methods_with_options, zero_decimal_currencies].hash
    end
