...
module DocuSign_eSign
  class RecipientTokenClientURLs
    # 
    attr_accessor :on_access_code_failed

    # 
    attr_accessor :on_cancel

    # 
    attr_accessor :on_decline

    # 
    attr_accessor :on_exception

    # 
    attr_accessor :on_fax_pending

    # 
    attr_accessor :on_id_check_failed

    # 
    attr_accessor :on_session_timeout

    # 
    attr_accessor :on_signing_complete

    # 
    attr_accessor :on_ttl_expired

    # 
    attr_accessor :on_viewing_complete
