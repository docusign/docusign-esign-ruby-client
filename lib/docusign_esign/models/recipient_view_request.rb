...
module DocuSign_eSign
  ...
  class RecipientViewRequest
    ...
    def hash
      [assertion_id, authentication_instant, authentication_method, client_user_id, email, ping_frequency, ping_url, recipient_id, return_url, security_domain, user_id, user_name, x_frame_options, x_frame_options_allow_from_url].hash
    end
