...
module DocuSign_eSign
  ...
  class AccountSettingsInformation
    ...
    ATTRIBUTE_MAP = lambda { |symbol| Utils.camelize_symbol(symbol, irregular_mappings: IRREGULAR_MAPPINGS) }.freeze
