...
module DocuSign_eSign
  ...
  class NotaryJournalList
    ...
    def self.swagger_types
      {
        :'end_position' => :'String',
        :'next_uri' => :'String',
        :'notary_journals' => :'Array<NotaryJournal>',
        :'previous_uri' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'notaryJournals')
        if (value = attributes[:'notaryJournals']).is_a?(Array)
          self.notary_journals = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          next_uri == o.next_uri &&
          notary_journals == o.notary_journals &&
    ...
    def hash
      [end_position, next_uri, notary_journals, previous_uri, result_set_size, start_position, total_set_size].hash
    end
