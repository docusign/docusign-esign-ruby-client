...
module DocuSign_eSign
  class NotaryJournal
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'notaryJournalId')
        self.notary_journal_id = attributes[:'notaryJournalId']
      end

      if attributes.has_key?(:'notaryJournalMetaData')
        self.notary_journal_meta_data = attributes[:'notaryJournalMetaData']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          notary_journal_id == o.notary_journal_id &&
          notary_journal_meta_data == o.notary_journal_meta_data &&
    ...
    def hash
      [created_date, document_name, jurisdiction, notary_journal_id, notary_journal_meta_data, signer_name].hash
    end
