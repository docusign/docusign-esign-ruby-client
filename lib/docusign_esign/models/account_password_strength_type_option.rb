...
module DocuSign_eSign
  class AccountPasswordStrengthTypeOption
    ...
    def hash
      [minimum_length, name, password_include_digit, password_include_digit_or_special_character, password_include_lower_case, password_include_special_character, password_include_upper_case].hash
    end
