...
module DocuSign_eSign
  class RecipientFormData
    # 
    attr_accessor :declined_time

    # 
    attr_accessor :delivered_time
    ...
    def hash
      [declined_time, delivered_time, email, form_data, name, recipient_id, sent_time, signed_time].hash
    end
