...
module DocuSign_eSign
  class LockRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'templatePassword')
        self.template_password = attributes[:'templatePassword']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          template_password == o.template_password &&
    ...
    def hash
      [lock_duration_in_seconds, locked_by_app, lock_type, template_password, use_scratch_pad].hash
    end
