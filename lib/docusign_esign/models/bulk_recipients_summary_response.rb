...
module DocuSign_eSign
  class BulkRecipientsSummaryResponse
    ...
    attr_accessor :bulk_recipients

    # The number of items returned in this response.
    attr_accessor :bulk_recipients_count
    ...
    def self.swagger_types
      {
        :'bulk_recipients' => :'Array<BulkRecipient>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bulkRecipients')
        if (value = attributes[:'bulkRecipients']).is_a?(Array)
          self.bulk_recipients = value
        end
      end

      if attributes.has_key?(:'bulkRecipientsCount')
        self.bulk_recipients_count = attributes[:'bulkRecipientsCount']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          bulk_recipients == o.bulk_recipients &&
          bulk_recipients_count == o.bulk_recipients_count &&
    ...
    def hash
      [bulk_recipients, bulk_recipients_count, bulk_recipients_uri, error_details].hash
    end
