...
module DocuSign_eSign
  ...
  class AccountSharedAccess
    ...
    def self.swagger_types
      {
        ...
        :'shared_access' => :'Array<MemberSharedItems>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'sharedAccess')
        if (value = attributes[:'sharedAccess']).is_a?(Array)
          self.shared_access = value
        end
      end
    ...
    def hash
      [account_id, end_position, error_details, next_uri, previous_uri, result_set_size, shared_access, start_position, total_set_size].hash
    end
